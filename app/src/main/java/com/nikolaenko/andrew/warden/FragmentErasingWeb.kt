...
import kotlinx.android.synthetic.main.fragment_eresing_web.*


class FragmentErasingWeb : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_eresing_web, container, false)
    }
